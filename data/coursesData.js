import { FaTshirt, FaPencilAlt, FaBolt } from 'react-icons/fa';
...
export const ourCoursesData = [
  {
    ...
    icon: <FaTshirt size={50} color='green' />,
  },
  {
    ...
    icon: <FaPencilAlt size={50} color='red' />,
  },
  {
    ...
    icon: <FaBolt size={50} color='yellow' />,
  },
];
