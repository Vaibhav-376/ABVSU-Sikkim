  ...
  return (
    <section>
      <div className="container mx-auto px-4 md:px-8 py-10 max-w-7xl">
        <h3 className='text-3xl font-bold pt-3'>Sports Activity</h3>
        <p className='text-justify pt-2'>
          {`At Atal Bihari Vajpayee Skill University (ABVSU), sports activity is an essential part of the university’s vision to promote physical fitness, discipline, and teamwork alongside skill-based education. Understanding the significance of sports in holistic student development, ABVSU offers structured activity programs across various sports, encouraging students to actively participate in physical activities.`}
        </p>
        <div className="flex flex-col md:flex-row gap-4 py-10">
          <div className="w-full md:w-1/2 flex flex-col gap-4 my-auto text-justify">
            <h3 className='text-3xl font-bold pt-3 text-[#003262]'>State-of-the-Art Sports Facilities </h3>
            <p>
              {`At Atal Bihari Vajpayee Skill University (ABVSU), students have access to modern sports facilities designed to support various athletic disciplines. The campus includes well-maintained playing fields, indoor sports complexes, and dedicated activity areas for sports such as basketball, football, cricket, badminton, and athletics. These facilities provide a professional activity environment, encouraging students to develop their skills and compete at higher levels.`}
            </p>
            <p>
              {`ABVSU is also committed to investing in high-quality sports equipment and resources. Students benefit from advanced activity gear, fitness equipment, and expert coaching, ensuring a well-rounded athletic experience. By fostering a culture of excellence in sports, the university promotes an active and healthy lifestyle for all students.`}
            </p>
          </div>
        ...
        <div className="flex flex-col md:flex-row gap-4 py-10">
          ...
          <div className="w-full md:w-1/2 flex flex-col gap-4 my-auto text-justify">
            <h3 className='text-3xl font-bold text-[#003262]'>Comprehensive activity Programs</h3>

            <p>
              At Atal Bihari Vajpayee Skill University (ABVSU), a wide range of sports activity programs are available to cater to both amateur and competitive athletes. These programs focus on developing fundamental skills, improving physical fitness, and enhancing overall athletic performance. Under the guidance of experienced coaches, students receive expert activity and support to help them reach their full potential.
            </p>

            <p>
              The sports activity curriculum is designed to cover all key aspects of athletic development, including strength and conditioning, skill enhancement, and strategic gameplay. Students engage in regular practice sessions, fitness activity, and competitive events, ensuring a holistic and well-rounded approach to sports. Through these programs, ABVSU fosters a culture of discipline, teamwork, and excellence in athletics.
            </p>
          </div>
        </div>

        <h3 className='text-3xl font-bold text-[#003262]'>Encouraging Teamwork and Leadership</h3>
        ...
        <h3 className='text-3xl font-bold pt-5 text-[#003262]'>Supportive Sportsactivity Staff</h3>
        <p className='text-justify'>{`Through team sports, students learn the importance of collaboration, strategic thinking, and shared responsibility, while individual sports promote self-discipline and resilience. Coaches at ABVSU emphasize these qualities, preparing students not just for sports competitions but also for future challenges in their personal and professional lives.`}</p>

        <h3 className='text-3xl font-bold pt-5 text-[#003262]'>Research and Learning Support </h3>
        ...
        <h3 className='text-3xl font-bold pt-3 text-[#003262]'>Fitness and Wellness Initiatives at ABVSU  </h3>
        ...
        <h3 className='text-3xl font-bold pt-3 text-[#003262]'> Career Opportunities in Sports </h3>
